...
def evaluate(test_dir: str, tokenizer_path: str, task: str, test_file_path: str, gt_img_dir: str, gt_svg_dir: str, caption_path: str):
    caption_dict = {}
...
def main():
    ...
    if len(text2svg_test_dir) > 0:
        evaluate(text2svg_test_dir, tokenizer_path, 'text2svg', test_file_path, gt_img_dir, gt_svg_dir, caption_path)
    if len(img2svg_test_dir) > 0:
        evaluate(img2svg_test_dir, tokenizer_path, 'img2svg', test_file_path, gt_img_dir, gt_svg_dir, caption_path)
