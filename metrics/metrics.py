...
from metrics.CLIP_Score import CLIPScoreCalculator
from metrics.DINO_Score import DINOScoreCalculator
from metrics.FID import FIDCalculator
from metrics.LPIPS import LPIPSCalculator
from metrics.PSNR import PSNRCalculator
from metrics.SSIM import SSIMCalculator
from metrics.token_length import TokenLengthCalculator
...
class CTRL_S_Metrics:
    ...
    def __repr__(self) -> str:
        ...
        return f"<CTRL-S Metrics active=[{metrics_list}]>"
