...
from utils.rl_prompt import IMG2SVG_QUESTION_TEMPLATE_EXPLICIT, TEXT2SVG_QUESTION_TEMPLATE_EXPLICIT
    ...
    with open(text2svg_test_path, 'r') as f:
        ...
        for line in lines:
            ...
            if not os.path.exists(svg_path):
                ...
                instruction = question.split('Instruction: ')[1]
                question = TEXT2SVG_QUESTION_TEMPLATE_EXPLICIT[0].format(instruction=instruction)
    ...
    with open(img2svg_test_path, 'r') as f:
        ...
        for line in lines:
            ...
            if not os.path.exists(svg_path):
                ...
                instruction = question.split('Instruction: ')[1]
                question = IMG2SVG_QUESTION_TEMPLATE_EXPLICIT[0].format(instruction=instruction)
                base_url = random.choice(base_url_list)
